          ...
          <div className='inner-wrapper'>
            ...
            <div className='inner-sidebar'>
              ...
              <div className='inner-sidebar-header justify-content-center'>
                <button
                  className='btn btn-success has-icon btn-block'
                  type='button'
                  data-toggle='modal'
                    ...
                    <div className='media forum-item'>
                      ...
                      <div className='media-body'>
                        ...
                        <p className='text-muted'>
                          <Link to='javascript:void(0)'>drewdan</Link> replied{' '}
                  ...
                  <div className='card-body p-2 p-sm-3'>
                    <div className='media forum-item'>
                      ...
                      <div className='media-body'>
                        ...
                        <p className='text-muted'>
                          <Link to='javascript:void(0)'>jlrdw</Link> replied{' '}
                          <span className='text-secondary font-weight-bold'>
                            3 hours ago
                          </span>
                        </p>
                  ...
                  <div className='card-body p-2 p-sm-3'>
                    <div className='media forum-item'>
                      ...
                      <div className='media-body'>
                        ...
                        <p className='text-muted'>
                          <Link to='javascript:void(0)'>ciungulete</Link>{' '}
                          replied{' '}
                          <span className='text-secondary font-weight-bold'>
                            7 hours ago
                          </span>
                  ...
                  <div className='card-body p-2 p-sm-3'>
                    <div className='media forum-item'>
                      ...
                      <div className='media-body'>
                        ...
                        <p className='text-muted'>
                          <Link to='javascript:void(0)'>bugsysha</Link> replied{' '}
                          <span className='text-secondary font-weight-bold'>
                            11 hours ago
                          </span>
                        </p>
                  ...
                  <div className='card-body p-2 p-sm-3'>
                    <div className='media forum-item'>
                      ...
                      <div className='media-body'>
                        ...
                        <p className='text-muted'>
                          <Link to='javascript:void(0)'>jackalds</Link> replied{' '}
                          <span className='text-secondary font-weight-bold'>
                            12 hours ago
                          </span>
                        </p>
                  ...
                  <div className='card-body p-2 p-sm-3'>
                    <div className='media forum-item'>
                      ...
                      <div className='media-body'>
                        ...
                        <p className='text-muted'>
                          <Link to='javascript:void(0)'>michaeloravec</Link>{' '}
                          replied{' '}
                          <span className='text-secondary font-weight-bold'>
                            18 hours ago
                          </span>
              ...
              <div className='inner-main-body p-2 p-sm-3 collapse forum-content'>
                ...
                <div className='card mb-2'>
                  <div className='card-body'>
                    <div className='media forum-item'>
                      <Link to='javascript:void(0)' className='card-link'>
                        <img
                          src='https://bootdey.com/img/Content/avatar/avatar1.png'
          ...
          >
            <div className='modal-dialog modal-lg' role='document'>
              <div className='modal-content'>
                <form>
                  <div className='modal-header d-flex align-items-center bg-success text-white'>
